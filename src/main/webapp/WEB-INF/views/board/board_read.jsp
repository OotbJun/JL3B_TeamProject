...
<body>
	...
	<div class="col mt-4">
		<div class="row">
			<div class="col"></div>
			<div class="col">
				<img src="${pageContext.request.contextPath }/resources/img/14.jpg"
					width=80%>
			</div>
			<div class="col"></div>
		</div>
	...
	<div class="container" style="margin-top: 20px; border: solid medium; border-color:blue;">
	 <div class="row">
	    <div class="col">${readBoard.boardVo.board_content }</div>
	 </div>
	</div>
	...
	${readBoard.upCount }
	<a
		href="${pageContext.request.contextPath }/board/choose_like_process.jan?board_like=N&board_no=${readBoard.boardVo.board_no }">싫어요</a>
	${readBoard.downCount }
	...
	<c:forEach items="${boardReplList}" var="boardReplList">
		<tr>
			...
			<td class="col4">작성날짜 : <fmt:formatDate
