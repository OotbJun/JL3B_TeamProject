...
<body>
   ...
   <div class="container" style="margin-top: 20px;">
      <div class="row"
         ...
         <c:if test="${!empty sessionUser && sessionUser.resi_no == readBoard.resiVo.resi_no || fn:contains(admin, 'admin') }">
          <a href="${pageContext.request.contextPath}/board/board_delete_process.jan?board_no=${readBoard.boardVo.board_no}">삭제</a>
        </c:if>
         </li>
            <li>
             <c:if  test="${!empty sessionUser && sessionUser.resi_no == readBoard.resiVo.resi_no}">
             <a  href="${pageContext.request.contextPath}/board/board_change.jan?board_no=${readBoard.boardVo.board_no}">수정</a>
            </c:if>
            </li>
               <li>
               <c:if test="${!empty sessionUser && sessionUser.resi_no == readBoard.resiVo.resi_no}">
               <a href="${pageContext.request.contextPath}/board/delete_board_img.jan?board_no=${readBoard.boardVo.board_no}">이미지삭제</a>
               </c:if>
               </li>
         </ul>
         </div>
   ...
   <!-- 댓글 리스트 -->
   <div class="container" style="margin-top: 20px; border-bottom: solid thin;; border-bottom-color: #f4f4f4">
