...
<body onload="open_tab()">
   ...
   <div class="wrapper fadeInDown">
      <div id="formContent">
         ...
         <!-- Tab content -->
         <div id="admin" class="tabcontent fadeIn !important">
            <form action="./login_process.do" method="post">
               <input type="text" id="login" class="second" name="admin_id"
                  placeholder="아이디"> <input type="password" id="password"
                  class="third" name="admin_pw" placeholder="비밀번호"> <input
