...
function submit_btn(){
      ...
      if(confirm("게시물을 등록하시겠습니까?")== true){
         document.getElementById("answer_submit").submit();
        ...
        <div class="container-fluid">
          ...
          <h1 class="h3 mb-4 text-gray-800">주민청원</h1>
              ...
              <h1 class="font-weight-light"></h1>
                  <p class="lead">주민청원 답변</p>
                     <form id="answer_submit" action="${path}/admin/idea_answer_process.do" method="post">
                  ...
                  <div class="row">   
                     <div class="col">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="idea_title" placeholder="제목을 입력해주세요" name="idea_title" value="답변 :" maxlength="50">                           
                           </div> 
                        </div>
                        <div class="col"></div>
                     <div class="col"></div>
                     ...
                     <div class="col"></div>
                        ...
                        <div class="form-group">
                           ...
                           <textarea class="form-control" id="idea_content"  placeholder="내용을 입력해주세요" rows="8" name="idea_content"></textarea>                           
                        </div>
