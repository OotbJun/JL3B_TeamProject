            ...
            <div class="row mt-3">
               ...
               <c:if
                  ...
                  <div class="col-4">
                     ...
                     <a
                        href="${pageContext.request.contextPath }/center/center_img.do"><button
                           type="button" class="btn btn-outline-primary btn-sm ">대표이미지
                           올리기</button></a> <a
                        href="${pageContext.request.contextPath }/center/center_write.do"><button
                           type="button" class="btn btn-outline-primary btn-sm">강의
                           등록</button></a>
                  </div>
               </c:if>
            </div>
                              ...
                              <div id="headingOne"
                                 ...
                                 <h6 class="mb-0 font-weight-bold">
                                    <a href="#" data-toggle="collapse"
                                       ...
                                       class="d-block position-relative text-dark collapsed text-uppercase collapsible-link py-2">클래스
                                       정보 </a>
                                 </h6>
                              </div>
